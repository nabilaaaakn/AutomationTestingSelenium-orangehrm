...
public class TC_003_01 {
    ...
    public static void main(String[] args) {
        ...
        By adminOption = By.xpath(
                "//div[@role='option' and normalize-space()='Admin']"
        );
...
// ===== VALIDASI =====
        boolean result = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//div[@role='cell' and normalize-space()='Admin']")
                )
        ).isDisplayed();


        if (result) {
            System.out.println("TC_003_01 PASS : User Role Admin tampil");
        } else {
            System.out.println("TC_003_01 FAIL");
        }
